<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>Editar Histórico de Cargo - <?php echo $pessoa['nome']; ?></h1>
...
<div class="card">
    <div class="card-body">
        <?php echo form_open('historico-cargos/editar/' . $historico['id']); ?>
            <div class="form-group">
                ...
                <select class="form-control <?php echo form_error('cargo_id') ? 'is-invalid' : ''; ?>" 
                    ...
                    <?php foreach ($cargos as $cargo): ?>
                        <option value="<?php echo $cargo['id']; ?>" <?php echo set_select('cargo_id', $cargo['id'], $historico['cargo_id'] == $cargo['id']); ?>>
                            <?php echo $cargo['nome']; ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control <?php echo form_error('data_inicio') ? 'is-invalid' : ''; ?>" 
                       id="data_inicio" name="data_inicio" value="<?php echo set_value('data_inicio', $historico['data_inicio']); ?>" required>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control <?php echo form_error('data_fim') ? 'is-invalid' : ''; ?>" 
                       id="data_fim" name="data_fim" value="<?php echo set_value('data_fim', $historico['data_fim']); ?>">
